    ...
    return (
        <div className="bg-green-50 min-h-screen flex flex-col items-center pt-10 px-6 pb-24 text-center">
            ...
            <div className="mt-8 w-full max-w-sm flex flex-col gap-3">
                <Link href={`https://www.google.com/maps/search/?api=1&query=12.9716,77.5946`} target="_blank" className="w-full bg-blue-600 text-white py-3.5 rounded-xl font-bold shadow-lg shadow-blue-200 flex items-center justify-center gap-2 hover:bg-blue-700 transition-colors">
