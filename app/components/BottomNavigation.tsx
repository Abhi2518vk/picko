...
export function BottomNavigation() {
  ...
  // Hide bottom navigation on login/onboarding pages
  const hiddenPaths = ["/login", "/login/", "/personal-info", "/personal-info/"];
  ...
  const navItems = [
    ...
    { label: "Categories", icon: Grid, href: "/categories", id: "categories" },
