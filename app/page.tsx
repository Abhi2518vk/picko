    ...
    <div className="pb-24">
      ...
      <section className="mt-4 px-4">
        {loading ? (
          ...
          <motion.div
            ...
            className="relative w-full h-40 rounded-2xl overflow-hidden shadow-lg premium-shadow bg-gradient-to-r from-red-400 to-red-600"
          >
            <div className="absolute inset-0 flex items-center justify-between px-6 text-white">
              <div className="z-10">
                ...
                <button className="mt-3 bg-white text-red-600 px-4 py-1.5 rounded-full text-xs font-bold shadow-md hover:shadow-lg transition-shadow">
                  Claim Now
                </button>
              </div>
              {/* Decorative Circles */}
          ...
          categories.map((cat, idx) => (
            <button
              ...
              className={`px-5 py-2 rounded-full whitespace-nowrap text-sm font-medium transition-all ${activeCategory === cat
                ...
                : "bg-white border border-gray-200 text-gray-600 shadow-sm hover:border-gray-300"
                }`}
            >
              {cat}
            </button>
      ...
      <section className="mt-6 px-4 space-y-6">
        <h3 className="text-lg font-bold text-gray-800">
          {activeCategory === "All" ? "Nearby Shops & Hotels" : `Nearby ${activeCategory}`}
        </h3>
